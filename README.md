...
This repo holds the **generic/synthetic** studies of the llm-wiki pattern — inputs
we authored, no third-party data, publishable. Experiments that touch a
collaborator's real wiki or corpus live in a **separate private repo** instead.

## Status

Working repo for in-progress research. Intended to be archived to Zenodo for a DOI
once the experiment sections are finalized.
